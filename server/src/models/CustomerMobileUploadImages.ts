...
class CustomerMobileUploadImages extends Model {
...
CustomerMobileUploadImages.init(
  {
    cust_id: {
  ...
  {
    sequelize,
    tableName: 't_customer_mobile_upload_images',
    schema: 'vo_dashboard',
    timestamps: false
  }
);

CustomerMobileUploadImages.belongsTo(CustomerDetails, {
  foreignKey: 'cust_id'
});

export default CustomerMobileUploadImages; 
